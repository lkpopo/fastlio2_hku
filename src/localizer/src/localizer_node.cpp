...
struct NodeConfig
{
    std::string cloud_topic = "/cloud_effected";
    std::string odom_topic = "/Odometry";
    std::string map_frame = "camera_init";
    std::string local_frame = "body";
...
public:
    ...
    void loadParameters()
    {
        ...
        this->declare_parameter<std::string>("local_frame");
        this->declare_parameter<double>("update_hz");

        this->declare_parameter<double>("rough_scan_resolution");
        this->declare_parameter<double>("rough_map_resolution");
        this->declare_parameter<int>("rough_max_iteration");
        this->declare_parameter<double>("rough_score_thresh");

        this->declare_parameter<double>("refine_scan_resolution");
        this->declare_parameter<double>("refine_map_resolution");
        this->declare_parameter<int>("refine_max_iteration");
        this->declare_parameter<double>("refine_score_thresh");

        // ---------- get ----------
        this->get_parameter("cloud_topic", m_config.cloud_topic);
        this->get_parameter("odom_topic", m_config.odom_topic);
        this->get_parameter("map_frame", m_config.map_frame);
        this->get_parameter("local_frame", m_config.local_frame);
        this->get_parameter("update_hz", m_config.update_hz);

        this->get_parameter("rough_scan_resolution", m_localizer_config.rough_scan_resolution);
        this->get_parameter("rough_map_resolution", m_localizer_config.rough_map_resolution);
        this->get_parameter("rough_max_iteration", m_localizer_config.rough_max_iteration);
        this->get_parameter("rough_score_thresh", m_localizer_config.rough_score_thresh);

        this->get_parameter("refine_scan_resolution", m_localizer_config.refine_scan_resolution);
        this->get_parameter("refine_map_resolution", m_localizer_config.refine_map_resolution);
        this->get_parameter("refine_max_iteration", m_localizer_config.refine_max_iteration);
        this->get_parameter("refine_score_thresh", m_localizer_config.refine_score_thresh);

        RCLCPP_INFO(this->get_logger(), "Localizer parameters loaded successfully");
    }
